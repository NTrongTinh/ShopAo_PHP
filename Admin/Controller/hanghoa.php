    ...
    switch ($act) {
            ...
            if (isset ($_SERVER['REQUEST_METHOD']) == "POST") {
                ...
                if ($flag) {
                    $tenmh = $_POST['tenmh'];
                        ...
                        $hh = new hanghoa();
                        uploadImage();
                        $check = $hh->insertHangHoa($tenmh, $maloai, $dongia, $giamgia, $hinhanh, $mota);
                        ...
                        if(isset($_POST['size']) && isset($_POST['soluong'])) {
                            ...
                            for($i = 0; $i < count($sizes); $i++) {
                                ...
                                // thêm vào bảng
                                $ct = new cthanghoa();
                                $ct->insertCTHangHoa($mamh, $size, $soluong);
                                // if ($check === false) {
                                //     break;
                                // }
        ...
        case 'update_action':
            if (isset ($_SERVER['REQUEST_METHOD']) == "POST") {
                ...
                $check = $hh->updateHangHoa($mamh, $tenmh, $maloai, $dongia, $giamgia, $mota);
                if ($check !== false) {
