...
<div class="row col-md-4 col-md-offset-4 mt-5" >
  ...
  ?>
    ...
    <table class="table table-hover" style="border: 0px;">
      ...
      <tr>
        <td>Mã hàng</td>
        <td> <input type="text" class="form-control" name="mamh" value="<?php if(isset($mahh)) echo $mahh;?>" readonly/></td>
      </tr>
      <?php endif;?>

      <tr>
        <td>Tên hàng</td>
        <td><input type="text" class="form-control" name="tenmh"  value="<?php if(isset($tenhh)) echo $tenhh;?>"  maxlength="100px"></td>
      </tr>
      ...
      <tr>
        ...
        <td>
            ...
            ?>
            <tr>
              <td><input type="checkbox" name="size[]" value="<?php echo $set['idsize']?>" onchange="enableNumberInput(this)"> <?php echo $set['tensize'];?></input></td>
