...
<div class="row">
         <?php
         $result = $hh->getAllHangHoaNewPage($start, $limit); //view lấy được dữ liệu là 8 hàng hóa mới nhất
         // đổ dữ liệu lên view
...
<div class="col-md-6 div col-md-offset-3">
				<ul class="pagination">
                    ...
                    for ( $i = 1; $i<=$page; $i++):
                    ?>
				    <li ><a href="index.php?action=allnew&page=<?php echo $i ?>"><?php echo $i?></a></li>
                        <?php endfor;?>
				</ul>
</div>
